...
Util.buildDetailView = async function(vehicle){
  ...
  // Price
  detailView += '<p class="vehicle-price"><strong>Price: </strong>$' 
  + new Intl.NumberFormat('en-US').format(vehicle.inv_price) + '</p>'
  
  // Description
  detailView += '<p class="vehicle-description"><strong>Description: </strong>' 
  + vehicle.inv_description + '</p>'
  
  // Color
  detailView += '<p class="vehicle-color"><strong>Color: </strong>' 
  + vehicle.inv_color + '</p>'
  
  // Mileage
  detailView += '<p class="vehicle-mileage"><strong>Mileage: </strong>' 
